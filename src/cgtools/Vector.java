...
public final class Vector {
  ...
  public static final Color orange = color(1, 0.5, 0);
  ...
  public static final Color pink = color(1, 0.5, 0.5);
  public static final Color brown = color(0.5, 0.25, 0);
  public static final Color violet = color(0.5, 0, 0.5);
  public static final Color lightblue = Vector.add(Vector.blue, Vector.green);
  public static final Color pastelgreen = Vector.add(Vector.gray, Vector.green);
  public static final Color pastelpurple = Vector.add(Vector.gray, Vector.blue);
  public static final Color pastelpink = Vector.add((Vector.gray), Vector.red);
  public static final Color lightyellow = Vector.add(Vector.gray, Vector.yellow);


    // Rotationsvektoren
    public static final Direction xRotation = new Direction(1, 0, 0);
    public static final Direction yRotation = new Direction(0, 1, 0);
    public static final Direction zRotation = new Direction(0, 0, 1);
}
